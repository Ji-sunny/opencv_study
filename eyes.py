...
def faceDetect():
    eye_detect = False
    face_cascade = cv2.CascadeClassifier("./haarcascade/haarcascade_frontalface_default.xml")  # 얼굴찾기 haar 파일
    eye_cascade = cv2.CascadeClassifier("./haarcascade/hiiaarcascade_eye.xml")  # 눈찾기 haar 파일
